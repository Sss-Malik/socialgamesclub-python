...
from common.utils.db_actions import get_backend, insert_backend_account, insert_log, update_order_automation_status, \
    ...
    update_order_status, update_wallet_detail_status
...
def _recharge_account(page: Page, logger: logging.Logger, points: int, account_id: str, order_id, task_id, wallet_id):
    ...
    for attempt in range(5):
        ...
        try:
            ...
            if "not authorized to check remaining balance" in text:
                restore_wallet_balance(wallet_id, points)
