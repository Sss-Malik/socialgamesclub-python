...
def _recharge_account(page: Page, logger: logging.Logger, amount: int, account_id: str, order_id, task_id, wallet_id):
    ...
    for msg in messages:
            ...
            if "not enougn balance" in text:
                restore_wallet_balance(wallet_id=wallet_id, restore_amount=amount)
